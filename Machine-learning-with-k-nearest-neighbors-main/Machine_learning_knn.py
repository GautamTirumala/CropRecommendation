...
print("Excel Dats : " , excel)                                                              # Printing our excel file data.
print("Excel Shape : ", excel.shape)                                                        # Checking out the shape of our data.
...
#string(crop name) converted to numbers 
...
print("Crop Preprocessed Data : " ,crop)
...
#transpose function shifts rows to colume and vise versa.
features = features.transpose()                                                                                # Making transpose of the features 
print("Transposed features :",features.shape)                                                                                          # Printing the shape of the features after getting transposed.
print("Crop shape :",crop.shape)                                                                                              # Printing the shape of crop. Please note that the shape of the features and crop should match each other to make predictions.

model = KNeighborsClassifier(n_neighbors=5)                                                                    # The number of neighbors is the core deciding factor. K is generally an odd number if the number of classes is 2. When K=1, then the algorithm is known as the nearest neighbor algorithm.
...
while True: 
	...
	print("Values given by the user :",predict1)   
	#to convert 1d Array to a 2D array reshape(1,-1) is used                                                                                                                          # Printing the data after being converted into a array form.
	...
	print("User Values converted into 2D array ",predict1)                                                                                                # Printing the input data value after being reshaped.
	predict1 = model.predict(predict1)                                                                             # Applying the user input data into the model. 
	print("Predected Crop Number :",predict1)                                                                                                # Finally printing out the results.
	crop_name = str()
	...
	print("nitrogen_level :"+ nitrogen_level)
	print("phosphorus_level :"+ phosphorus_level)
	print("potassium_level :"+ potassium_level)
	print("temperature_level :"+ temperature_level)
	print("humidity_level :" +humidity_level)
	print("phlevel :" +phlevel)
	print("rainfall_level :"+ rainfall_level)
